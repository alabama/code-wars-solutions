  ...
  while (true) {
    ...
    switch (fid) {
      ...
      if (ftype == Thrift.Type.STRING) {
        this.string_to_check = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
...
var InvalidStringError = module.exports.InvalidStringError = function(args) {
  Thrift.TException.call(this, "InvalidStringError");
...
InvalidStringError.prototype.read = function(input) {
  ...
  while (true) {
    ...
    switch (fid) {
      case 1:
      if (ftype == Thrift.Type.STRING) {
        this.whatString = input.readString();
      } else {
        input.skip(ftype);
      }
      break;
