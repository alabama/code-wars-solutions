// https://www.codewars.com/kata/52a0f488852a85c723000aca/javascript
...
function palindromize(number){
  for(var i = 1; i <= 1000; i++) {
    ...
    if(isPalindromize(number)) {
      return i.toString() + ' ' + number.toString();;
    }
  }

}

function isPalindromize(number) {
  return (number.toString() === reverseNumber(number).toString());
}
