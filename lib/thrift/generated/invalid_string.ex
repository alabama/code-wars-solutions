defmodule(Thrift.Generated.InvalidString) do
  @moduledoc(false)
  _ = "Auto-generated Thrift exception nested.InvalidString"
  ...
  defmodule(BinaryProtocol) do
    ...
    def(deserialize(binary)) do
      deserialize(binary, %Thrift.Generated.InvalidString{})
    end
    defp(deserialize(<<0, rest::binary>>, %Thrift.Generated.InvalidString{} = acc)) do
      {acc, rest}
    end
    ...
    def(serialize(%Thrift.Generated.InvalidString{what_string: what_string, why: why})) do
      [case(what_string) do
        nil ->
          <<>>
        _ ->
